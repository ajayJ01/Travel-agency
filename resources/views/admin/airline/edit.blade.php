                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('vendor.update', $vendors->id) }}" enctype='multipart/form-data'>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <label for="type" class="col-form-label">Environment</label>
                                <div>
                                        ...
                                        <tbody>
                                            @if (!empty($vendors->live_credentials))
                                                {{-- @foreach ($vendors->live_credentials as $key => $credential)
                                                    <tr>
                                                        <td>{{ $loop->iteration }}</td>
                                                        <td><input type="text" name="live_type[]"
                                                                value="{{ old('live_type.' . $loop->index, $credential['key']) }}"
                                                                class="form-control"></td>
                                                        <td><input type="text" name="live_value[]"
                                                                value="{{ old('live_value.' . $loop->index, $credential['value']) }}"
                                                                class="form-control"></td>
                                               ...
                                               @foreach ($vendors->live_credentials as $key => $credential)
                                                <tr>
                                                    <td>{{ $loop->iteration }}</td>
                                                    <td>
                                                        <input type="text" name="live_type[]"
                                                            value="{{ old('live_type.' . $loop->index, $credential['key']) }}"
                                                            class="form-control">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="live_value[]"
                                                            value="{{ old('live_value.' . $loop->index, $credential['value']) }}"
                                                            class="form-control">
                                                    </td>
                                                    <td>
